...
Ask about: name and age, the platform(s) you freelanced on and for how long, your rating and review count, total projects completed, repeat-client count or rate, response rate or platform badges/tier.
...
Also surface: industries served, team or collaboration experience (even informal, e.g. working with a developer or another freelancer), tools used, any mentoring or informal leadership.
...
const INTRO_MESSAGE = {
  role: "assistant",
  content: `Hello! I'm Hatua — a career translation agent built for African freelance designers transitioning into formal remote roles.
...
Let's start with the basics: **Your name, age, which platform have you been freelancing on, and for roughly how long?**`
};
...
export default function Hatua() {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      // Detect output phase
      if (reply.includes("ATS-FORMATTED CV") || reply.includes("INTERVIEW-PREP")) {
        setPhase("outputs");
      }
    } catch (err) {
