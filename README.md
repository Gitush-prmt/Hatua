...
Built by: Gits Mwai — UI Designer / Certified Prompt Engineer / IBM Generative AI Engineering Professional Timeline: 10 weeks (June – August 2026) Stack: Claude API · React · Jobscan (ATS validation) Live demo: (add link) Full case study: (add Notion link)
...
Every user confirmed every bullet was accurate — nothing they couldn't defend in an interview. When asked "Would you submit this CV to a real application tomorrow?" — all six said yes.
